...
- ## Background
 if you want to know what is <b>CI/CD</b> <br>
...
- ## Contionus Integration - Jenkins
    ...
    - Create a Job on Jenkins using jenkins dasshboard with your GitHub repository. While creating the Job add your GitHub repository url as shown below in the Source Management section.
   ...
   In this pipeline , I'm not deploying application on sever, but when you build the Job you can use the applicayion in your localhost, port:5000.. The Artifactory stage that used in the Jenkinsfile will be coverd below.
...
- ## JFrog Artifactory
    ...
    - You can use [jfrog](https://jfrog.com/open-source/) open source.
